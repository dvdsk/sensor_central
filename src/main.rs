...
use protocol::large_bedroom::desk::Error::Setup;
use protocol::large_bedroom::desk::SetupError;
...
fn main() {
    ...
    if let Err(e) = buttons::start_monitoring(tx.clone()) {
        send_error(&tx, Setup(SetupError::Gpio(e)));
    }
